...
1. לאפיין כללי תיוג ברורים לכל מחלקה, כולל דוגמאות חיוביות, דוגמאות שליליות ומקרי גבול.
2. להגדיר האם התיוג נעשה על בסיס השאלה בלבד, או על בסיס השאלה יחד עם התשובה, הראיות ומסמכי המקור. יש להבחין בין תיוג לצורך ניתוח מחקרי לבין תיוג בזמן אמת.
3. לבנות מנגנון שיוך ראשוני למחלקות, כנראה בשילוב LLM labeling ואימות אנושי.
4. לאסוף בנצ'מארקים מרכזיים מבוססי מסמכים ולהגדיר קריטריונים ברורים להכללה. חשוב למצוא לפחות בנצ'מארק אחד בעל אופי ארגוני שבו צפויות יותר שאלות מהמחלקות הפחות שכיחות.
5. לבצע פיילוט תיוג על בנצ'מארק אחד או שניים, לבדוק agreement אנושי, לתחקר פערים, ואז לדייק את המחלקות ואת תהליך התיוג.

### דרך פתרון קרובה
הכיוון הראשוני הוא לייצר שיטת תיוג שבה המודל מקבל את השאלה, התשובה, ומידע נוסף שהבנצ'מארק מספק כגון מסמכי המקור או הראיות. במקום לבקש תווית ישירה בלבד, נבקש ממנו לפרק את תהליך המענה: אילו פעולות אדם היה צריך לבצע כדי לענות על השאלה, ואילו סוגי מקורות קרקוע היו נחוצים בכל שלב.

קשיים שצריך לבדוק כבר בפיילוט:

1. האם תהליך כזה מצליח לזהות שימוש במטאדאטה כאשר המטאדאטה אינו מופיע במפורש בראיות שסופקו.
2. האם ניתן לזהות שאלות אונטולוגיות או אגרגטיביות כאשר הבנצ'מארקים עצמם בנויים סביב ראיות טקסטואליות.
3. האם מודל שפה נוטה "למשוך" כל שאלה חזרה למחלקת הראיות, גם כאשר מקור הקרקוע האמיתי רחב יותר.
4. מה רמת ההסכמה בין מתייגים אנושיים, והאם המחלקות מספיק יציבות כדי לשמש בסיס למאמר.

במקביל יש לרכז את הבנצ'מארקים הרלוונטיים: מבוססי מסמכים, עם שאלות-תשובות ניתנות למענה, ורצוי עם גישה למסמכי המקור או לראיות. בשלב הראשון התיוג יהיה רב-בחירה ושטוח, ולא עץ היררכי.
